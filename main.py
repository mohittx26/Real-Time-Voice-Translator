...
def open_about_page():      # about page
    ...
    github_link = ttk.Label(about_window, text="github.com/mohittx26/Real-Time-Voice-Translator", underline=True, foreground="blue", cursor="hand2")
    github_link.bind("<Button-1>", lambda e: open_webpage("https://github.com/mohittx26/Real-Time-Voice-Translator"))
    github_link.pack()
